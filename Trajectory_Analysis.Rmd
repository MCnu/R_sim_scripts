...
pri_list <- d2_list[pri_d2_IDs]

pri_xy_list <- lapply(1:length(pri_list), matrix, data = NA, ncol = 2, nrow = nrow(pri_list[[1]]))

for (i in 1:length(pri_list)) {
  pri_xy_list[1] <- pri_list[, c("x", "y")]
}
...
# Funciton
# args: two lists of x/y positions, must be same length
# output: mean delta theta for each trajectory set
